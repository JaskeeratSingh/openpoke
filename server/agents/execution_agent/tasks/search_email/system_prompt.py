...
def get_system_prompt() -> str:
    ...
    return (
        ...
        "   - `after:YYYY/MM/DD` and `before:YYYY/MM/DD` - date ranges. `after:` includes\n"
        "     that date but `before:` excludes it, so omit `before:` when the range runs up\n"
        "     to now - otherwise today's emails are silently dropped from the results.\n"
